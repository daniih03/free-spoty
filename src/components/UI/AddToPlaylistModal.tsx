...
export const AddToPlaylistModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-neutral-900/95 border border-white/10 rounded-3xl p-6 sm:p-7 shadow-2xl shadow-black/90 backdrop-blur-2xl overflow-hidden"
